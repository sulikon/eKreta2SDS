...
rem Felhasználók kezdő jelszavának eleje Legyen legalább 4 betű, kisbetűt, nagybetűt és egy jelet is tartalmazzon. 
rem A kezdő jelszóba az itt megadott prefix után a felhasználó saját oktatási azonosítójának utolsó 4 számjegye kerül.
...
rem Többiskolás környezetekben célszerű lehet az egyes iskolák csoportjainak megkülönböztetése.
rem Itt adható meg az az előtag, amivel minden csoport neve kezdődik - ha meg van adva.
rem set param10=-SchoolSectionPrefix "Próbavár"

rem Többiskolás környezetekben célszerű lehet az egyes iskolák csoportjainak megkülönböztetése.
rem Itt adható meg az az utótag, amely minden csoport nevébe bekerül a tanév elé - ha meg van adva.
